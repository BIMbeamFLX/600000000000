...
export const workspaceTools = {
  chapters: { slug: 'chapter-directory', title: 'Local chapters', description: 'Find a place to meet.' },
  calendar: { slug: 'calendar', title: 'Guild calendar', description: 'Make time to meet.' },
  tasks: { slug: 'operation-board', title: 'Guild tasks', description: 'Pick a job. Build together.' },
  roles: { slug: 'role-manager', title: 'Guild duties', description: 'Assign a specific responsibility.' },
